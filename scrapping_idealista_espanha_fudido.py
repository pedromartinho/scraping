...
first_page=""
get_page=link_page.split("pagina-")
if len(get_page)==1:
    first_page=1
else:
    i=0
...
for page in range(first_page,last_page+1):
    ...
    for offer_div in soup_page.find_all("div", { "class" : "item-info-container" }):
        ...
        link_offer= "https://www.idealista.com"+html_href
        print(link_offer)
...
#        var=link_page.split("?")
#        if len(var)==1:
#            var=link_page.split("pagina-1.htm")
#            added="pagina-2.htm"
#        else:
#            added="pagina-2?"
#        link_page=var[0]+added+var[1]
#    else:
    added="pagina-"+str(page)
    var=link_page.split(added)
    link_page=var[0]+"pagina-"+str(page+1)+var[1]
fp.close()
